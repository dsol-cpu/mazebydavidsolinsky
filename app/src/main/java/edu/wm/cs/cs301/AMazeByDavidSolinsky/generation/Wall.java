...
import edu.wm.cs.cs301.AMazeByDavidSolinsky.gui.*;
...
public class Wall {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        switch (((d >> 3) ^ cc) % 6) {
        case 0:
            setColor(Color.rgb(rgbValue, RGB_DEF, RGB_DEF));
            break;
        case 1:
            setColor(Color.rgb(RGB_DEF, RGB_DEF_GREEN, RGB_DEF));
            break;
        case 2:
            setColor(Color.rgb(RGB_DEF, RGB_DEF, rgbValue));
            break;
        case 3:
            setColor(Color.rgb(rgbValue, RGB_DEF_GREEN, RGB_DEF));
            break;
        case 4:
            setColor(Color.rgb(RGB_DEF, RGB_DEF_GREEN, rgbValue));
            break;
        case 5:
            setColor(Color.rgb(rgbValue, RGB_DEF, rgbValue));
            break;
        default:
            setColor(Color.rgb(RGB_DEF, RGB_DEF, RGB_DEF));
            break;
        }
    }
