...
/**
 * This class contains all constants that are used in the maze package and
...
public class Constants {
	...
	public static int[] SKILL_PARTCT = { 60, 600, 900, 1200, 2100, 2700, 3300, 5000, 6000, 13500, 19800, 25000, 29000,
			45000, 85000, 85000 * 4 };

	// Possible user input
	public enum UserInput {
		W, A, S, D, ReturnToTitle, Start, Up, Down, Left, Right, Jump, ToggleLocalMap, ToggleFullMap, ToggleSolution,
		ZoomIn, ZoomOut, Enter
	};
